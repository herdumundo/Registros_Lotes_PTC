...
<%                          
    ...
    try {
       ...
       String consulta_sql=" exec [select_lotes_disponibles_transferencias]  @area='"+area+"',@area_cch='"+area_cch+"',@cod_carrito='"+carro+"',@tipo_transferencia='A'"; 
       
            rs_GM = fuente_GM.obtenerDato(consulta_sql) ;
        while(rs_GM.next())
        {      
        verificador_SAP= rs_GM.getString("tipo_huevo");  
        ob=new JSONObject();
        ob.put("id", rs_GM.getString("cod_interno"));
        ob.put("item_codigo", rs_GM.getString("tipo_nombre"));
