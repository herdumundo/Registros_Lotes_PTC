       ...
       area="OVO";
        ...
        try {
           ...
           
           {
            ...
            ResultSet rs_carro_embarque = fuente.obtenerDato("select  * from embarque_det   where SUBSTRING(lote,1,6)='"+nrocarro2+"' and estado in ('N','P')");
            ...
            String getDBUSERByUserIdSql = "{call pa_liberado_costeado(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
