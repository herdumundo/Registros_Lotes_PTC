...
<div class="col-xl-3 col-md-6 mb-4">
 ...
 <div class="col-xl-3 col-md-6 mb-4" onclick="ir_transformacion_pallet_carro()" > <!--grilla_retenidos_panel.jsp    -->
                ...
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      ...
                      <div class="row no-gutters align-items-center">
                        <div class="col-auto">
                          <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><font color="black"><b>POR FECHA DE CLASIFICACION</b></font></div>
                        </div>
                        <div class="col">
            ...
            <div class="col-xl-3 col-md-6 mb-4" onclick="traer_retenido_fecha_puesta()" >
              <div class="card border-left-info shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-info text-uppercase mb-1"><font color="black"><b>REGISTRO DE MOVIMIENTOS</b></font></div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><font color="black"><b>POR FECHA DE PUESTA</b></font></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-clipboard-list fa-2x text-celeste"></i>
                    </div>
