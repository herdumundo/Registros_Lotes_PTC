...
<%@include  file="../chequearsesion.jsp" %>
    ...
    JSONArray jarray = new JSONArray();
        ...
        try {
       /* ResultSet rs = fuente.obtenerDato(" exec [select_movimientos_ptc] @clasificadora='"+clasificadora+"',"
       ...
       ResultSet rs = fuente.obtenerDato("exec [select_movimientos_ptc] @clasificadora='A',@clasificadora_cch='CCHA',@fecha='15/12/2020',@hora_inicio='00',@hora_fin='24',@tipo_estado='R',@tipo_consulta='P'");
                                                    // YA CONTIENE M_LOTES  
         ...
         ob=new JSONObject();
          ...
          ob.put("1",  rs.getString("cod_carrito"));        
          ob.put("2",  rs.getString("tipo_huevo"));        
          ob.put("3",  rs.getString("estado_liberacion"));        
          ob.put("4",  rs.getString("tipo"));        
          ob.put("5",  rs.getString("disposicion"));        
          ob.put("6",  rs.getString("tipo_costeo"));        
            jarray.put(ob);        
