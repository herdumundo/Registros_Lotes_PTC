...
%>
   ...
   <%
    ...
    ResultSet liberados = fuente.obtenerDato("          exec [mae_ptc_select_totalCarrosPorTiposLiberados] @clasificadora='"+area+"' , @fecha='"+calendario+"'");
    ResultSet carros_retenidos = fuente.obtenerDato("	exec [mae_ptc_select_totalCarrosPorTiposRetenidos] @clasificadora='"+area+"' , @fecha='"+calendario+"' ");
     if(liberados.next()){
