  ...
  if( valor_grilla.length==0){
   ...
   Swal.fire({
    ...
    function agregar_motivo_retencion(){
       ...
       $.ajax({
                type: "POST",
                url: ruta_controles+'control_agregar_motivo_retencion.jsp',
    ...
    function reemplazar_motivo_retencion(){
       ...
       $.ajax({
                type: "POST",
                url: ruta_controles+'control_reemplazar_motivo_retencion.jsp',
                data:  $("#form_motivo_retencion").serialize(),
                beforeSend: function() {
                   $('#div_cargar').show();
                    $('#btn_motivo').hide()                     },           
    ...
    function reemplazar_estado_producto(){
       ...
       $.ajax({
                type: "POST",
                url: ruta_controles+'control_reemplazar_estado_producto.jsp',
    ...
    function reemplazar_disposicion(){
       ...
       $.ajax({
                type: "POST",
                url: ruta_controles+'control_reemplazar_disposicion.jsp',
    ...
    function agregar_estado_producto(){
       ...
       $.ajax({
                type: "POST",
                url: ruta_controles+'control_agregar_estado_producto.jsp',
                data:  $("#form_estado_producto").serialize(),
                beforeSend: function() {
                   $('#div_cargar_estado').show();
                   $('#btn_producto').hide();
